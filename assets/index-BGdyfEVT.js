            ...
            <div class="w-full bg-white shadow-xl rounded-2xl overflow-hidden relative border border-gray-100">
                <div id="screen-intro" class="p-6 sm:p-8">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100 flex flex-col items-center">
                        ...
                        <button onclick="window.app.prepareTest('dark')" class="w-full sm:w-auto px-8 py-3 rounded-xl font-medium text-[#ffffff] bg-[#6455E5] hover:opacity-90 transition-all shadow-md focus:outline-none focus:ring-2 focus:ring-[#6455E5] focus:ring-offset-2 flex items-center justify-center">
                ...
                <div id="screen-task" class="p-6 sm:p-8">
                    ...
                    <div class="bg-purple-50/50 rounded-2xl p-5 sm:p-6 mb-6 border border-purple-100">
                        ...
                        <div class="space-y-3 text-purple-950 text-base leading-relaxed">
                            <p>Você é assinante da plataforma de streaming <strong>Dark Max</strong> há cerca de 6 meses. No entanto, você está fazendo um corte de gastos nas suas finanças pessoais este mês.</p>
            ...
            <div class="w-full bg-white shadow-xl rounded-2xl overflow-hidden relative border border-gray-100">
                ...
                <div id="screen-tcle" class="screen active p-6 sm:p-8">
                    ...
                    <p class="text-gray-700 text-sm sm:text-base mb-4 leading-relaxed text-justify">
                        Prezado(a) participante, agradecemos por concluir a atividade no simulador. Para garantir o rigor ético desta pesquisa acadêmica da Universidade Federal do Ceará (UFC), realizamos agora o esclarecimento completo sobre a natureza deste estudo.
                    </p>
                    ...
                    <div class="max-w-none text-gray-600 space-y-3 mb-4 text-xs sm:text-sm leading-relaxed text-justify border border-gray-100 p-4 rounded-xl bg-gray-50">
                        ...
                        <div>
                            ...
                            <p>O atrito, o cansaço ou a frustração eventualmente percebidos durante a execução da tarefa foram gerados artificialmente pelo design do sistema para fins de medição científica de latência cognitiva. Ressaltamos de forma categórica que o sistema foi projetado para ser obstrutivo, e quaisquer dificuldades ou cliques errados são decorrentes da manipulação da interface, e não de sua capacidade ou atenção.</p>
                        </div>
